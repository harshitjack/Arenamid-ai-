...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#07070A] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute -bottom-[10%] -right-[10%] w-[500px] h-[500px] bg-stadiumPurple/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <GlassCard glowColor="blue" className="w-full">
          <h2 className="text-xl font-bold text-white mb-6">Login to Stadium OS</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-neonBlue to-emeraldGreen hover:from-neonBlue hover:to-emeraldGreen text-[#07070A] font-bold py-3 rounded-xl shadow-lg shadow-neon-blue/20 hover:opacity-90 active:scale-[0.99] transition-all text-sm mt-6"
            >
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            New operator? <Link to="/register" className="text-neonBlue hover:underline">Request access</Link>
          </p>
        </GlassCard>

        {/* MOCK LOGINS DRAWER */}
        <div className="mt-6 glass rounded-2xl border border-white/5 p-4 text-xs">
          <p className="font-bold text-gray-400 mb-2.5 uppercase tracking-wider text-[10px]">Developer Sandbox Logins</p>
          <div className="grid grid-cols-2 gap-2 text-[11px]">
            <button 
              onClick={() => handleQuickLogin('admin@arenamind.com', 'admin123')}
              className="bg-white/5 hover:bg-white/10 text-left p-2 rounded-lg border border-white/5 hover:border-neonBlue/20 text-gray-300 flex flex-col"
            >
            ...
            <button 
              ...
              className="bg-white/5 hover:bg-white/10 text-left p-2 rounded-lg border border-white/5 hover:border-emeraldGreen/20 text-gray-300 flex flex-col"
            >
            ...
            <button 
              ...
              className="bg-white/5 hover:bg-white/10 text-left p-2 rounded-lg border border-white/5 hover:border-stadiumPurple/20 text-gray-300 flex flex-col"
            >
            ...
            <button 
              ...
              className="bg-white/5 hover:bg-white/10 text-left p-2 rounded-lg border border-white/5 hover:border-amber-400/20 text-gray-300 flex flex-col"
            >
